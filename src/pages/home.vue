<template>
    <div class="home-block">
            <blockquote v-for="item in menus" :key="item.Key" class="layui-elem-quote layui-quote-nm left-block" @click="$options.filters.openRoute(item.MenuUrl)" >
